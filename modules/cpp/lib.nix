...
with builtins;
{
  ...
  mkLibcxxStdenv = llvmVersion:
    let
      ...
      muslClang = pkgs.pkgsMusl.pkgsLLVM.clang_18; #llvmPackages_18.clangUseLLVM; # .overrideAttrs (old: {
    ...
    then pkgs.pkgsMusl.pkgsLLVM.stdenv  #pkgs.stdenvAdapters.overrideCC stdenv' muslClang
    else pkgs.pkgsLLVM;
}
